...
namespace TerraTemp.Utilities {
    public abstract class ItemChange {
        ...
        /// <summary>
        /// List that returns what item's IDs have the given item as a material in any part of the crafting tree.
        ...
        /// </summary>
        public virtual List<int> ItemsThatContainThis => new List<int>();
