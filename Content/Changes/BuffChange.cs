...
namespace TerraTemp.Content.Changes {
    ...
    public abstract class BuffChange {
        ...
        /// </summary>
        public virtual string AdditionalBuffTip => TempUtilities.CreateNewLineBasedOnStats(HeatComfortabilityChange, ColdComfortabilityChange, TemperatureResistanceChange, CriticalTemperatureChange, DesiredTemperatureChange, ClimateExtremityChange);
    }
}